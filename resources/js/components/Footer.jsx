                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="md:hidden mt-6">
                            ...
                            <div className="flex gap-3 flex-wrap">
                                <a
                                    href="https://wa.me/212614128481"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-12 h-12 bg-white/10 hover:bg-green-500 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group backdrop-blur-sm"
                                    aria-label="WhatsApp"
                                >
