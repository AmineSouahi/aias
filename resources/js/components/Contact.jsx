                            ...
                            <div className="mt-8 pt-6 border-t border-gray-200">
                                ...
                                <div className="flex gap-4 flex-wrap">
                                    ...
                                    <a
                                        ...
                                        className="w-14 h-14 bg-green-50 hover:bg-green-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 group shadow-sm"
                                        aria-label="WhatsApp"
                                    >
